...
{
    public partial class HomeContains : System.Web.UI.UserControl
    {
        ...
        private void Load_Hottour()
        {
            try
            {
                var list = index.Loadindex(2, 3, Const.LANGVI, 20);
        ...
        private void Load_TourPopular()
        {
            try
            {
                var list = index.Loadindex(2, 4, Const.LANGVI, 20);
        ...
        private void Load_TourDifferent()
        {
            try
            {
                var list = index.Loadindex(2, 5, Const.LANGVI, 20);
