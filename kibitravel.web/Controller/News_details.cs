            ...
            try
            {
                ...
                if (_sNews_Seo_Url != "")
                {
                    ...
                    var _tinTucKhac = (from c in db.ESHOP_NEWS_CATs
                                       ...
                                       select new { a.NEWS_ID, a.NEWS_TITLE,b.CAT_NAME, a.NEWS_IMAGE3,a.NEWS_PRICE1, a.NEWS_DESC, a.NEWS_SEO_URL, a.NEWS_URL, a.NEWS_ORDER, a.NEWS_ORDER_PERIOD, a.NEWS_PUBLISHDATE,a.NEWS_FIELD3, c.ESHOP_CATEGORy.CAT_SEO_URL }).OrderByDescending(n => n.NEWS_PUBLISHDATE).OrderByDescending(n => n.NEWS_ORDER).Take(9).Distinct();
