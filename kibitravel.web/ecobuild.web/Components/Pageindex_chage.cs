...
namespace GiaNguyen.Components
{
    public class Pageindex_chage
    {
        ...
        public string result_EN(int tongsotin, int sotin, string cat_seo_url, int idarea, int _page, int type)
        {
            string _re = string.Empty;
            int kiemtradu = tongsotin % sotin;
            int _sotrang;
                ...
                for (int i = s; i <= _sotrang; i++)
                {
                    ...
                    else
                    {
                        if (type == 2)
                        {
                            if (i == _sotrang && _page >= 7)
                            {
                                _re += "<a href='/en/search.html?page=" + (_page + 1) + "&keyword=" + cat_seo_url + "'> >> </a>";
                            }
                            else if (i == s && _page >= 7)
                            {
                                _re += "<a href='/en/search.html?page=" + (_page - 1) + "&keyword=" + cat_seo_url + "'> >> </a>";
                                ...
                                _re += "<a href='/en/search.html?page=" + i + "&keyword=" + cat_seo_url + "'>" + i + "</a>";
                        }
                        else if (type == 1)
                        {
                            if (i == _sotrang && _page >= 7)
                            {
                                _re += "<a href='/en/" + cat_seo_url + ".html?page=" + (_page + 1) + "'> >> </a>";
                            }
                            else if (i == s && _page >= 7)
                            {
                                _re += "<a href='/en/" + cat_seo_url + ".html?page=" + (_page - 1) + "'> << </a>";
                                ...
                                _re += "<a href='/en/" + cat_seo_url + ".html?page=" + i + "'>" + i + "</a>";
                        }
