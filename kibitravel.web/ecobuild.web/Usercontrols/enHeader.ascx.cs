...
{
    public partial class enHeader : System.Web.UI.UserControl
    {
        #region Declare
        ...
        public string Getbanner(object Banner_type, object banner_field, object Banner_ID, object Banner_Image)
        {
            ...
            {
                str = fun.Getlogo(Banner_type, banner_field, Banner_ID, Banner_Image, "/home.html");
            }
            return str;
        }
        #endregion
        ...
        protected void Load_Menu1()
        {
            try
            {
                Rpmenu.DataSource = per.Loadmenu(0, 20, 1, Const.LANGEN, -1);
                Rpmenu.DataBind();
            }
            catch (Exception ex)
            {
