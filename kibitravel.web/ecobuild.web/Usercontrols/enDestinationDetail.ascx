<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="enDestinationDetail.ascx.cs" Inherits="kibitravel.web.Usercontrols.enDestinationDetail" %>
                ...
                <ItemTemplate>
                    <div class="slide">
                      <article class="destinations-it">
                        <div class="inner-dt">
                          <figure class="img-dt"><a href='<%# GetLink(Eval("NEWS_URL"),Eval("NEWS_SEO_URL"),Eval("CAT_SEO_URL"))%>'><%# GetImageT(Eval("NEWS_ID"), Eval("NEWS_IMAGE3"))%></a></figure>
