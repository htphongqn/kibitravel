...
{
    public partial class enFooter : System.Web.UI.UserControl
    {    
        #region Declare
        ...
        {
            Literal_Info.Text = cf.Show_File_HTML("footer-e.htm", "/Data/footer/");
        }
        ...
        protected void Load_Menu1()
        {
            try
            {
                Rpmenu.DataSource = per.Loadmenu(1, 2, 1, Const.LANGEN, -1);
                Rpmenu.DataBind();
            }
            catch (Exception ex)
            {
