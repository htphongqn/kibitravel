<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="enTopHeader.ascx.cs" Inherits="kibitravel.web.Usercontrols.enTopHeader" %>
...
<div class="top">
    ...
    <p class="lang-box">
        <a href="/trang-chu.html"><img src="/Resources/images/vi.png"></a>
