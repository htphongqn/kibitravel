<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Bestdeals.ascx.cs" Inherits="kibitravel.web.Usercontrols.Bestdeals" %>
       ...
       <asp:Repeater ID="rptmenubestdeal" runat="server">
            <ItemTemplate>
                <article class="tour-mt">
                  ...
                  <figure class="img-mt"> <a href="<%#GetLink(Eval("cat_url"),Eval("cat_seo_url"),1)%>"><img src="<%# GetImageCat(Eval("CAT_ID"),Eval("CAT_IMAGE1"))%>"  /></a>
                    <div class="des-mt">
