...
{
    public partial class Main_en : System.Web.UI.Page
    {
        #region Declare
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                UserControl ListNews = Page.LoadControl("../Usercontrols/enListNews.ascx") as UserControl;
                UserControl NewsDetail = Page.LoadControl("../Usercontrols/enNewsDetail.ascx") as UserControl;

                UserControl ListBlog = Page.LoadControl("../Usercontrols/enListBlog.ascx") as UserControl;
                UserControl BlogDetail = Page.LoadControl("../Usercontrols/enBlogDetail.ascx") as UserControl;

                UserControl SocialActivities = Page.LoadControl("../Usercontrols/enSocialActivities.ascx") as UserControl;
                UserControl SocialActivitiesDetail = Page.LoadControl("../Usercontrols/enSocialActivitiesDetail.ascx") as UserControl;

                UserControl Bestdeals = Page.LoadControl("../Usercontrols/enBestdeals.ascx") as UserControl;
                UserControl ListBestdeals = Page.LoadControl("../Usercontrols/enListBestdeals.ascx") as UserControl;
                UserControl BesdealsDetail = Page.LoadControl("../Usercontrols/enBesdealsDetail.ascx") as UserControl;

                UserControl Destinations = Page.LoadControl("../Usercontrols/enDestinations.ascx") as UserControl;
                UserControl ListDestinations = Page.LoadControl("../Usercontrols/enListDestinations.ascx") as UserControl;
                UserControl DestinationDetail = Page.LoadControl("../Usercontrols/enDestinationDetail.ascx") as UserControl;

                UserControl SearchResult = Page.LoadControl("../Usercontrols/enSearchResult.ascx") as UserControl;
        ...
        public void Bind_meta_tags_index()
        {
            ...
            if (_configs.ToList().Count > 0)
            {
                header.Title = _configs.ToList()[0].CONFIG_TITLE_EN;

                headerDes.Content = _configs.ToList()[0].CONFIG_DESCRIPTION_EN;
                header.Controls.Add(headerDes);

                headerKey.Content = _configs.ToList()[0].CONFIG_KEYWORD_EN;
                header.Controls.Add(headerKey);
            }
            else
            {
