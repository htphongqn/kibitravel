    ...
    public partial class Main_en : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                UserControl list_pro = Page.LoadControl("../Usercontrols/enListProject.ascx") as UserControl;
                UserControl prodetails = Page.LoadControl("../Usercontrols/enProjectDetail.ascx") as UserControl;
                UserControl list_news = Page.LoadControl("../Usercontrols/enListNews.ascx") as UserControl;
                UserControl details_news = Page.LoadControl("../Usercontrols/enNewsDetail.ascx") as UserControl;
